...
{
    // 1538 - 2048
    //sys_thread_new("HTTP", http_server_socket_thread, NULL, DEFAULT_THREAD_STACKSIZE * 2, WEBSERVER_THREAD_PRIO+1);
    sys_thread_new("HTTP", http_server_socket_thread, NULL, DEFAULT_THREAD_STACKSIZE * 2, osPriorityNormal+2);
}
...
void DynWebPage(int conn)
{
    ...
    // примерно 40 байт на задачу + обвязка
    ...
    //------------------------------------------------------------------------------------------
//    strcat((char *) PAGE_BODY, "<br><br><br>" );
//    strcat((char *) PAGE_BODY, "<br>---------------------------------------------<br>");
//    strcat((char *) PAGE_BODY, "  My data" );
//    strcat((char *) PAGE_BODY, "<br>---------------------------------------------<br>");
    /* The list of tasks and their status */
    //vTaskList((signed char *)(PAGE_BODY + strlen(PAGE_BODY)));
//    strcat((char *) PAGE_BODY, "<br>---------------------------------------------<br>");
